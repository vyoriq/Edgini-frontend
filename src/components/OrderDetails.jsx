      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-6">
            {isSuccess 
              ? `Your ${orderData?.subscription_info?.tier || ''} subscription has been activated successfully.`
              : orderData?.payment_info?.failure_reason 
                ? `Payment failed: ${orderData.payment_info.failure_reason}`
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className={`font-semibold capitalize ${isSuccess ? 'text-green-600' : 'text-red-600'}`}>
                  {orderData?.payment_info?.status || 'Unknown'}
                </span>
              </div>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-800">
                    {orderData.subscription_info.daily_limit === -1 
                      ? 'Unlimited' 
                      : `${orderData.subscription_info.daily_limit} queries`
                    }
                  </span>
                </div>
              )}
